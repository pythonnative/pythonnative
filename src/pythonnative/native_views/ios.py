...
def _present_alert(
    *,
    ...
    """Internal: present a UIAlertController of the given style."""
    try:
        ...
        for spec in buttons:
            ...
            action = UIAlertAction.actionWithTitle_style_handler_(
                label,
                kind_int,
                make_handler(cb) if cb is not None else None,
            )
