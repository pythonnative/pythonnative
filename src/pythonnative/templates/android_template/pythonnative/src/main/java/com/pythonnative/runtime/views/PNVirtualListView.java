...
/**
 * RecyclerView-backed virtualized list used by PythonNative's VirtualList manager.
 *
 * <p>The adapter and view holders live here; row content is delegated to the
 * {@link Delegate}, which the VirtualList manager implements by asking Python
 * for a row subtree through the synchronous {@code on_bind_row} protocol.</p>
 *
 ...
 * forwarded to the delegate in dp.</p>
 */
public class PNVirtualListView extends RecyclerView {
    public interface Delegate {
        ...
        void bindRow(int position, FrameLayout container, float widthDp, float heightDp);
