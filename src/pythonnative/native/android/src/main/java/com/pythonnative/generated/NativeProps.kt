...
object PNComponentEvents {
    ...
    object Image {
        fun `on_load_start`(view: android.view.View): Boolean = PNEvents.fire(view, "on_load_start")
        ...
        fun `on_load_end`(view: android.view.View): Boolean = PNEvents.fire(view, "on_load_end")
    ...
    object Modal {
        ...
        fun `on_request_close`(view: android.view.View): Boolean = PNEvents.fire(view, "on_request_close")
        fun `on_layout`(view: android.view.View, argument0: PNLayoutEvent): Boolean = PNEvents.fire(view, "on_layout", PNValues.encode(argument0))
    }
    object Picker {
    ...
    object ScrollView {
        fun `on_scroll`(view: android.view.View, argument0: PNScrollEvent): Boolean = PNEvents.fire(view, "on_scroll", PNValues.encode(argument0))
        fun `on_scroll_begin_drag`(view: android.view.View, argument0: PNScrollEvent): Boolean = PNEvents.fire(view, "on_scroll_begin_drag", PNValues.encode(argument0))
        fun `on_scroll_end_drag`(view: android.view.View, argument0: PNScrollEvent): Boolean = PNEvents.fire(view, "on_scroll_end_drag", PNValues.encode(argument0))
        fun `on_momentum_scroll_end`(view: android.view.View, argument0: PNScrollEvent): Boolean = PNEvents.fire(view, "on_momentum_scroll_end", PNValues.encode(argument0))
        fun `on_layout`(view: android.view.View, argument0: PNLayoutEvent): Boolean = PNEvents.fire(view, "on_layout", PNValues.encode(argument0))
        fun `on_refresh`(view: android.view.View): Boolean = PNEvents.fire(view, "on_refresh")
    }
    ...
    object Text {
        ...
        fun `on_accessibility_action`(view: android.view.View, argument0: String): Boolean = PNEvents.fire(view, "on_accessibility_action", PNValues.encode(argument0))
        fun `on_layout`(view: android.view.View, argument0: PNLayoutEvent): Boolean = PNEvents.fire(view, "on_layout", PNValues.encode(argument0))
        fun `on_span_press`(view: android.view.View, argument0: Long): Boolean = PNEvents.fire(view, "on_span_press", PNValues.encode(argument0))
    }
    object TextInput {
        fun `on_change`(view: android.view.View, argument0: String): Boolean = PNEvents.fire(view, "on_change", PNValues.encode(argument0))
        fun `on_selection_change`(view: android.view.View, argument0: PNSelectionEvent): Boolean = PNEvents.fire(view, "on_selection_change", PNValues.encode(argument0))
        fun `on_submit`(view: android.view.View, argument0: String): Boolean = PNEvents.fire(view, "on_submit", PNValues.encode(argument0))
        fun `on_key_press`(view: android.view.View, argument0: PNKeyPressEvent): Boolean = PNEvents.fire(view, "on_key_press", PNValues.encode(argument0))
        fun `on_content_size_change`(view: android.view.View, argument0: PNContentSizeEvent): Boolean = PNEvents.fire(view, "on_content_size_change", PNValues.encode(argument0))
